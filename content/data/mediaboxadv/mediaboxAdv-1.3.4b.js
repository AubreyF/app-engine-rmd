...
(function() {
	...
	Mediabox = {
		...
		open: function(_images, startImage, _options) {
			options = $extend({
				text: ['&laquo; Prev','Next &raquo;','<big>Close Slideshow</big>'],		// Set "previous", "next", and "close" button content (HTML code should be written as entity codes or properly escaped)
...
//	example		text: ['<b>P</b>rev','<b>N</b>ext','<b>C</b>lose'],
				...
				keyboard: false,				// Enables keyboard control; escape key, left arrow, and right arrow
				...
				defaultWidth: 1024,				// Default width of the box (in pixels) for undefined media (MP4, FLV, etc.)
				defaultHeight: 768,				// Default height of the box (in pixels) for undefined media (MP4, FLV, etc.)
