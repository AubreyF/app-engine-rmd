  ...
  // END MEMOIZE
   Diabox = new Class({
    ...
    options : {
      ...
      iframe : {                              
        width : 1024,                           // the content width of an iframe renderable
        height: 768                             // the content height of an iframe renderable
      },                                      
      image : {                               
      ...
      gallery : {                             
        enabled : false,                         // allow galleries to be created and iterated through
      ...
      title : {                               
        ...
        show : false,                            // show titles
        show_gallery_index : false,              // show the current page of the gallery (1 / 3), (3 / 5), etc
      ...
      overlay : {                             
        ...
        opacity : 0.85,                          // the end opacity of the overlay
    ...
    register_renderables : function(){
      ...
      this.register_renderable('ajax', Diabox.RemoteRenderable);
      this.register_renderable('remote', Diabox.RemoteRenderable);
      this.register_renderable('inline', Diabox.RemoteRenderable);
